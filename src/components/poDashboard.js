...
export default class PoDashboard extends Component{
    constructor(props){
        super(props)
        this.state={
            loading:true,
    ...
    getDataLengths = () => {
        ...
        axios.get(endpoint.host+"/getDataSizes/po").
        then((response) =>{
    ...
    getData = (type) => {
        this.setState({loading:true}, () =>{
            ...
            axios.get(endpoint.host+`/getData/${type}/po`).
            then( async (response) => {
                console.log(response.data)
...
<Row>
    ...
    <h1 style={{display:'inline'}}>Po Dashboard</h1> 
    </Col>
...
<div>
            <Row>
             ...
             <h5>Total PO Queries : {this.state.lengths?this.state.lengths.Total:""}</h5>
...
<h5>Total PO Mt : {this.state.lengths?this.state.lengths.mt:""}</h5>
...
<h5>Total 100 Kg PO : {this.state.lengths?this.state.lengths.kg:""}</h5>
...
<h5>Rest PO Queries : {this.state.lengths?this.state.lengths.rest:""}</h5>
